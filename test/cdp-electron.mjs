...
await shot('screenshot-electron-script.png');

for (const [label, file] of [['分镜', 'screenshot-electron-storyboard.png'], ['角色', 'screenshot-electron-characters.png'], ['画布', 'screenshot-electron-canvas.png']]) {
